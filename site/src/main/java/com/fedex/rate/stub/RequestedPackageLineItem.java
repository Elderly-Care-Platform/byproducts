...
public class RequestedPackageLineItem implements java.io.Serializable {
  ...
  /*
   * Specifies the declared value for carriage of the package. The declared value for carriage
   * represents the maximum liability of FedEx in connection with a shipment, including, but not
   * limited to, any loss, damage, delay, mis-delivery, nondelivery, misinformation, any failure to
   * provide information, or mis-delivery of information relating to the package. This field is only
   * used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. Ignored for PACKAGE_SUMMARY, in which case
   * totalInsuredValue and packageCount on the shipment will be used to determine this value.
   */
  private com.fedex.rate.stub.Money insuredValue;

  /*
   * Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. Ignored for PACKAGE_SUMMARY, in which
   * case total weight and packageCount on the shipment will be used to determine this value.
   */
  ...
  /*
   * Provides additional detail on how the customer has physically packaged this item. As of June
   * 2009, required for packages moving under international and SmartPost services.
   */
  ...
  public RequestedPackageLineItem(org.apache.axis.types.PositiveInteger sequenceNumber,
      ...
      com.fedex.rate.stub.Money insuredValue, com.fedex.rate.stub.Weight weight,
      com.fedex.rate.stub.Dimensions dimensions,
      com.fedex.rate.stub.PhysicalPackagingType physicalPackaging,
      java.lang.String itemDescription, java.lang.String itemDescriptionForClearance,
   ...
   * 
   * @return sequenceNumber * Used only with INDIVIDUAL_PACKAGE, as a unique identifier of each
   *         requested package.
   */
   ...
   * 
   * @param sequenceNumber * Used only with INDIVIDUAL_PACKAGE, as a unique identifier of each
   *        requested package.
   */
   ...
   * 
   * @return groupNumber * Used only with PACKAGE_GROUPS, as a unique identifier of each group of
   *         identical packages.
   */
   ...
   * 
   * @param groupNumber * Used only with PACKAGE_GROUPS, as a unique identifier of each group of
   *        identical packages.
   */
   ...
   * 
   * @return groupPackageCount * Used only with PACKAGE_GROUPS, as a count of packages within a
   ...
   * 
   * @param groupPackageCount * Used only with PACKAGE_GROUPS, as a count of packages within a group
   ...
   */
  public void setVariableHandlingChargeDetail(
      com.fedex.rate.stub.VariableHandlingChargeDetail variableHandlingChargeDetail) {
    this.variableHandlingChargeDetail = variableHandlingChargeDetail;
  }
   ...
   * 
   * @return insuredValue * Specifies the declared value for carriage of the package. The declared
   *         value for carriage represents the maximum liability of FedEx in connection with a
   *         shipment, including, but not limited to, any loss, damage, delay, mis-delivery,
   *         nondelivery, misinformation, any failure to provide information, or mis-delivery of
   *         information relating to the package. This field is only used for INDIVIDUAL_PACKAGES
   *         and PACKAGE_GROUPS. Ignored for PACKAGE_SUMMARY, in which case totalInsuredValue and
   *         packageCount on the shipment will be used to determine this value.
   */
   ...
   * 
   * @param insuredValue * Specifies the declared value for carriage of the package. The declared
   *        value for carriage represents the maximum liability of FedEx in connection with a
   *        shipment, including, but not limited to, any loss, damage, delay, mis-delivery,
   *        nondelivery, misinformation, any failure to provide information, or mis-delivery of
   *        information relating to the package. This field is only used for INDIVIDUAL_PACKAGES and
   *        PACKAGE_GROUPS. Ignored for PACKAGE_SUMMARY, in which case totalInsuredValue and
   *        packageCount on the shipment will be used to determine this value.
   */
   ...
   * 
   * @return weight * Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. Ignored for
   ...
   * 
   * @param weight * Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. Ignored for
   *        PACKAGE_SUMMARY, in which case total weight and packageCount on the shipment will be
   *        used to determine this value.
   */
   ...
   *         packaged this item. As of June 2009, required for packages moving under international
   *         and SmartPost services.
   */
   ...
   * 
   * @return itemDescriptionForClearance * Human-readable text describing the contents of the
   *         package to be used for clearance purposes.
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof RequestedPackageLineItem))
      return false;
    ...
    _equals =
        true
            && ((this.sequenceNumber == null && other.getSequenceNumber() == null) || (this.sequenceNumber != null && this.sequenceNumber
                .equals(other.getSequenceNumber())))
            && ((this.groupNumber == null && other.getGroupNumber() == null) || (this.groupNumber != null && this.groupNumber
                .equals(other.getGroupNumber())))
            && ((this.groupPackageCount == null && other.getGroupPackageCount() == null) || (this.groupPackageCount != null && this.groupPackageCount
                .equals(other.getGroupPackageCount())))
            && ((this.variableHandlingChargeDetail == null && other
                .getVariableHandlingChargeDetail() == null) || (this.variableHandlingChargeDetail != null && this.variableHandlingChargeDetail
                .equals(other.getVariableHandlingChargeDetail())))
            && ((this.insuredValue == null && other.getInsuredValue() == null) || (this.insuredValue != null && this.insuredValue
                .equals(other.getInsuredValue())))
            && ((this.weight == null && other.getWeight() == null) || (this.weight != null && this.weight
                .equals(other.getWeight())))
            && ((this.dimensions == null && other.getDimensions() == null) || (this.dimensions != null && this.dimensions
                .equals(other.getDimensions())))
            && ((this.physicalPackaging == null && other.getPhysicalPackaging() == null) || (this.physicalPackaging != null && this.physicalPackaging
                .equals(other.getPhysicalPackaging())))
            && ((this.itemDescription == null && other.getItemDescription() == null) || (this.itemDescription != null && this.itemDescription
                .equals(other.getItemDescription())))
            && ((this.itemDescriptionForClearance == null && other.getItemDescriptionForClearance() == null) || (this.itemDescriptionForClearance != null && this.itemDescriptionForClearance
                .equals(other.getItemDescriptionForClearance())))
            && ((this.customerReferences == null && other.getCustomerReferences() == null) || (this.customerReferences != null && java.util.Arrays
                .equals(this.customerReferences, other.getCustomerReferences())))
            && ((this.specialServicesRequested == null && other.getSpecialServicesRequested() == null) || (this.specialServicesRequested != null && this.specialServicesRequested
                .equals(other.getSpecialServicesRequested())))
            && ((this.contentRecords == null && other.getContentRecords() == null) || (this.contentRecords != null && java.util.Arrays
                .equals(this.contentRecords, other.getContentRecords())));
    __equalsCalc = null;
    return _equals;
  }
  ...
  public synchronized int hashCode() {
    ...
    if (getCustomerReferences() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getCustomerReferences()); i++) {
    ...
    if (getContentRecords() != null) {
      for (int i = 0; i < java.lang.reflect.Array.getLength(getContentRecords()); i++) {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16",
        "RequestedPackageLineItem"));
    org.apache.axis.description.ElementDesc elemField =
        new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("sequenceNumber");
    elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16",
        "SequenceNumber"));
    ...
    elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16",
        "VariableHandlingChargeDetail"));
    elemField.setMinOccurs(0);
    elemField.setNillable(false);
    typeDesc.addFieldDesc(elemField);
    ...
    elemField
        .setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Dimensions"));
    elemField
        .setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Dimensions"));
    elemField.setMinOccurs(0);
    elemField.setNillable(false);
    typeDesc.addFieldDesc(elemField);
    elemField = new org.apache.axis.description.ElementDesc();
