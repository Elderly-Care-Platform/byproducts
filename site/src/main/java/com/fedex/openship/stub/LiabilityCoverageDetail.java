...
public class LiabilityCoverageDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.LiabilityCoverageType coverageType;

    /* Identifies the Liability Coverage Amount. For Jan 2010 this
     * value represents coverage amount per pound */
    private com.fedex.openship.stub.Money coverageAmount;

    public LiabilityCoverageDetail() {
    }

    public LiabilityCoverageDetail(
           com.fedex.openship.stub.LiabilityCoverageType coverageType,
           com.fedex.openship.stub.Money coverageAmount) {
     ...
     * @return coverageType
     */
    public com.fedex.openship.stub.LiabilityCoverageType getCoverageType() {
        return coverageType;
    }
     ...
     * @param coverageType
     */
    public void setCoverageType(com.fedex.openship.stub.LiabilityCoverageType coverageType) {
        this.coverageType = coverageType;
    }
     ...
     * value represents coverage amount per pound
     */
    public com.fedex.openship.stub.Money getCoverageAmount() {
     ...
     * value represents coverage amount per pound
     */
    public void setCoverageAmount(com.fedex.openship.stub.Money coverageAmount) {
        this.coverageAmount = coverageAmount;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LiabilityCoverageDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("coverageType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CoverageType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LiabilityCoverageType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("coverageAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CoverageAmount"));
