/**
 * DeleteOpenConsolidationReply.java
 *
...
public class DeleteOpenConsolidationReply  implements java.io.Serializable {
    ...
    public DeleteOpenConsolidationReply() {
    }
    ...
    /**
     * Gets the highestSeverity value for this DeleteOpenConsolidationReply.
     * 
    ...
    /**
     * Sets the highestSeverity value for this DeleteOpenConsolidationReply.
     * 
    ...
    /**
     * Gets the notifications value for this DeleteOpenConsolidationReply.
     * 
    ...
    /**
     * Sets the notifications value for this DeleteOpenConsolidationReply.
     * 
     * @param notifications
     */
    ...
    /**
     * Gets the transactionDetail value for this DeleteOpenConsolidationReply.
     * 
    ...
    /**
     * Sets the transactionDetail value for this DeleteOpenConsolidationReply.
     * 
    ...
    /**
     * Gets the version value for this DeleteOpenConsolidationReply.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this DeleteOpenConsolidationReply.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteOpenConsolidationReply)) return false;
        DeleteOpenConsolidationReply other = (DeleteOpenConsolidationReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteOpenConsolidationReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DeleteOpenConsolidationReply"));
