...
public class CompletedHazardousPackageDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.RadioactiveLabelType labelType;

    /* Documents the kinds and quantities of all hazardous commodities
     * in the current package. */
    private com.fedex.openship.stub.ValidatedHazardousContainer[] containers;
    ...
    public CompletedHazardousPackageDetail(
           ...
           com.fedex.openship.stub.RadioactiveLabelType labelType,
           com.fedex.openship.stub.ValidatedHazardousContainer[] containers) {
     ...
     * radioactive material being handled as well as the relative risk.
     */
    public com.fedex.openship.stub.RadioactiveLabelType getLabelType() {
        return labelType;
    }
     ...
     * radioactive material being handled as well as the relative risk.
     */
    public void setLabelType(com.fedex.openship.stub.RadioactiveLabelType labelType) {
        this.labelType = labelType;
    }
     ...
     * in the current package.
     */
    public com.fedex.openship.stub.ValidatedHazardousContainer[] getContainers() {
        return containers;
    }
     ...
     * in the current package.
     */
    public void setContainers(com.fedex.openship.stub.ValidatedHazardousContainer[] containers) {
        this.containers = containers;
    }

    public com.fedex.openship.stub.ValidatedHazardousContainer getContainers(int i) {
        return this.containers[i];
    }

    public void setContainers(int i, com.fedex.openship.stub.ValidatedHazardousContainer _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedHazardousPackageDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RadioactiveTransportIndex"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LabelType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RadioactiveLabelType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ValidatedHazardousContainer"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
