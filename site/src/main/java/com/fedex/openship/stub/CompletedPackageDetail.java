...
public class CompletedPackageDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.SignatureOptionType signatureOption;
    ...
    public CompletedPackageDetail(
           ...
           com.fedex.openship.stub.OversizeClassType oversizeClass,
           com.fedex.openship.stub.PackageRating packageRating,
           com.fedex.openship.stub.PackageOperationalDetail operationalDetail,
           com.fedex.openship.stub.ShippingDocument label,
           com.fedex.openship.stub.ShippingDocument[] packageDocuments,
           com.fedex.openship.stub.CodReturnPackageDetail codReturnDetail,
           com.fedex.openship.stub.SignatureOptionType signatureOption,
     ...
     */
    public com.fedex.openship.stub.OversizeClassType getOversizeClass() {
        return oversizeClass;
    }
     ...
     * @param oversizeClass
     */
    public void setOversizeClass(com.fedex.openship.stub.OversizeClassType oversizeClass) {
        this.oversizeClass = oversizeClass;
    }
     ...
     * data for multiple rate types.
     */
    public com.fedex.openship.stub.PackageRating getPackageRating() {
     ...
     * data for multiple rate types.
     */
    public void setPackageRating(com.fedex.openship.stub.PackageRating packageRating) {
        this.packageRating = packageRating;
    }
     ...
     * @return label
     */
    public com.fedex.openship.stub.ShippingDocument getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(com.fedex.openship.stub.ShippingDocument label) {
        this.label = label;
    }
     ...
     * barcodes). For use in loads after January, 2008.
     */
    public com.fedex.openship.stub.ShippingDocument[] getPackageDocuments() {
     ...
     * barcodes). For use in loads after January, 2008.
     */
    public void setPackageDocuments(com.fedex.openship.stub.ShippingDocument[] packageDocuments) {
        this.packageDocuments = packageDocuments;
    }

    public com.fedex.openship.stub.ShippingDocument getPackageDocuments(int i) {
        return this.packageDocuments[i];
    }

    public void setPackageDocuments(int i, com.fedex.openship.stub.ShippingDocument _value) {
     ...
     * has COD special service in a ground shipment.
     */
    public com.fedex.openship.stub.CodReturnPackageDetail getCodReturnDetail() {
     ...
     * has COD special service in a ground shipment.
     */
    public void setCodReturnDetail(com.fedex.openship.stub.CodReturnPackageDetail codReturnDetail) {
        this.codReturnDetail = codReturnDetail;
    }
     ...
     * the original value conflicted with other service features in the shipment.
     */
    public com.fedex.openship.stub.SignatureOptionType getSignatureOption() {
     ...
     * the original value conflicted with other service features in the shipment.
     */
    public void setSignatureOption(com.fedex.openship.stub.SignatureOptionType signatureOption) {
        this.signatureOption = signatureOption;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedPackageDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "OversizeClass"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "OversizeClassType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("packageRating");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageRating"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageRating"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageOperationalDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("label");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Label"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageDocuments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ShippingDocument"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodReturnDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodReturnPackageDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("signatureOption");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "SignatureOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "SignatureOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "HazardousPackageDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedHazardousPackageDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
