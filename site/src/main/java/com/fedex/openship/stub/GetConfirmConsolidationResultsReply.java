/**
 * GetConfirmConsolidationResultsReply.java
 *
...
public class GetConfirmConsolidationResultsReply  implements java.io.Serializable {
    ...
    public GetConfirmConsolidationResultsReply() {
    }
    ...
    /**
     * Gets the highestSeverity value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Sets the highestSeverity value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Gets the notifications value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Sets the notifications value for this GetConfirmConsolidationResultsReply.
     * 
     * @param notifications
     */
    ...
    /**
     * Gets the transactionDetail value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Sets the transactionDetail value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Gets the version value for this GetConfirmConsolidationResultsReply.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetConfirmConsolidationResultsReply.
     * 
     * @param version
     */
    ...
    /**
     * Gets the completedConsolidationDetail value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    /**
     * Sets the completedConsolidationDetail value for this GetConfirmConsolidationResultsReply.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetConfirmConsolidationResultsReply)) return false;
        GetConfirmConsolidationResultsReply other = (GetConfirmConsolidationResultsReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetConfirmConsolidationResultsReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "GetConfirmConsolidationResultsReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedConsolidationDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedConsolidationDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
