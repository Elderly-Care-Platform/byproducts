...
public class DocumentFormatOptionsRequested  implements java.io.Serializable {
    private com.fedex.openship.stub.DocumentFormatOptionType[] options;

    public DocumentFormatOptionsRequested() {
    }

    public DocumentFormatOptionsRequested(
           com.fedex.openship.stub.DocumentFormatOptionType[] options) {
     ...
     * @return options
     */
    public com.fedex.openship.stub.DocumentFormatOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.openship.stub.DocumentFormatOptionType[] options) {
        this.options = options;
    }

    public com.fedex.openship.stub.DocumentFormatOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.openship.stub.DocumentFormatOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DocumentFormatOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DocumentFormatOptionType"));
