...
public class PendingShipmentAccessDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.PendingShipmentAccessorDetail[] accessorDetails;

    public PendingShipmentAccessDetail() {
    }

    public PendingShipmentAccessDetail(
           com.fedex.openship.stub.PendingShipmentAccessorDetail[] accessorDetails) {
     ...
     */
    public com.fedex.openship.stub.PendingShipmentAccessorDetail[] getAccessorDetails() {
        return accessorDetails;
    }
     ...
     */
    public void setAccessorDetails(com.fedex.openship.stub.PendingShipmentAccessorDetail[] accessorDetails) {
        this.accessorDetails = accessorDetails;
    }

    public com.fedex.openship.stub.PendingShipmentAccessorDetail getAccessorDetails(int i) {
        return this.accessorDetails[i];
    }

    public void setAccessorDetails(int i, com.fedex.openship.stub.PendingShipmentAccessorDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PendingShipmentAccessDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("accessorDetails");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AccessorDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PendingShipmentAccessorDetail"));
