...
public class ConsolidationDataSourceType implements java.io.Serializable {
    ...
    // Constructor
    protected ConsolidationDataSourceType(java.lang.String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final java.lang.String _ACCUMULATED = "ACCUMULATED";
    ...
    public static ConsolidationDataSourceType fromValue(java.lang.String value)
    ...
    public static ConsolidationDataSourceType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationDataSourceType"));
    }
    /**
