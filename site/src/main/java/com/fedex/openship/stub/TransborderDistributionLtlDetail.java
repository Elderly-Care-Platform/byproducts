...
public class TransborderDistributionLtlDetail  implements java.io.Serializable {
    ...
    private java.lang.String ltlScacCode;
     ...
     */
    public java.lang.String getLtlScacCode() {
        return ltlScacCode;
    }
     ...
     */
    public void setLtlScacCode(java.lang.String ltlScacCode) {
        this.ltlScacCode = ltlScacCode;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "TransborderDistributionLtlDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LtlScacCode"));
