...
public class ShipmentManifestDetail  implements java.io.Serializable {
     ...
     * manifest ID. */
    private com.fedex.openship.stub.CustomerReferenceType manifestReferenceType;

    public ShipmentManifestDetail() {
    }

    public ShipmentManifestDetail(
           com.fedex.openship.stub.CustomerReferenceType manifestReferenceType) {
     ...
     * manifest ID.
     */
    public com.fedex.openship.stub.CustomerReferenceType getManifestReferenceType() {
     ...
     * manifest ID.
     */
    public void setManifestReferenceType(com.fedex.openship.stub.CustomerReferenceType manifestReferenceType) {
        this.manifestReferenceType = manifestReferenceType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ShipmentManifestDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("manifestReferenceType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ManifestReferenceType"));
