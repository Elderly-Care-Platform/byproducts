...
public class ConfirmOpenShipmentReply  implements java.io.Serializable {
    ...
    public ConfirmOpenShipmentReply() {
    }
    ...
    /**
     * Gets the highestSeverity value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the highestSeverity value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Gets the notifications value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the notifications value for this ConfirmOpenShipmentReply.
     * 
     * @param notifications
     */
    ...
    /**
     * Gets the transactionDetail value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the transactionDetail value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Gets the version value for this ConfirmOpenShipmentReply.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this ConfirmOpenShipmentReply.
     * 
     * @param version
     */
    ...
    /**
     * Gets the jobId value for this ConfirmOpenShipmentReply.
     * 
     * @return jobId
     */
    ...
    /**
     * Sets the jobId value for this ConfirmOpenShipmentReply.
     * 
     * @param jobId
     */
    ...
    /**
     * Gets the asynchronousProcessingResults value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the asynchronousProcessingResults value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Gets the completedShipmentDetail value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the completedShipmentDetail value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Gets the errorLabels value for this ConfirmOpenShipmentReply.
     * 
    ...
    /**
     * Sets the errorLabels value for this ConfirmOpenShipmentReply.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfirmOpenShipmentReply)) return false;
        ConfirmOpenShipmentReply other = (ConfirmOpenShipmentReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfirmOpenShipmentReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConfirmOpenShipmentReply"));
