...
public class ShippingDocumentDispositionDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.ShippingDocumentDispositionType dispositionType;
    ...
    private com.fedex.openship.stub.ShippingDocumentEMailDetail EMailDetail;

    /* Specifies how a queued document is to be printed. */
    private com.fedex.openship.stub.ShippingDocumentPrintDetail printDetail;

    public ShippingDocumentDispositionDetail() {
    }

    public ShippingDocumentDispositionDetail(
           com.fedex.openship.stub.ShippingDocumentDispositionType dispositionType,
           com.fedex.openship.stub.ShippingDocumentGroupingType grouping,
           com.fedex.openship.stub.ShippingDocumentEMailDetail EMailDetail,
           com.fedex.openship.stub.ShippingDocumentPrintDetail printDetail) {
     ...
     */
    public com.fedex.openship.stub.ShippingDocumentDispositionType getDispositionType() {
     ...
     */
    public void setDispositionType(com.fedex.openship.stub.ShippingDocumentDispositionType dispositionType) {
        this.dispositionType = dispositionType;
    }
     ...
     */
    public com.fedex.openship.stub.ShippingDocumentEMailDetail getEMailDetail() {
        return EMailDetail;
    }
     ...
     */
    public void setEMailDetail(com.fedex.openship.stub.ShippingDocumentEMailDetail EMailDetail) {
        this.EMailDetail = EMailDetail;
    }
     ...
     */
    public com.fedex.openship.stub.ShippingDocumentPrintDetail getPrintDetail() {
        return printDetail;
    }
     ...
     */
    public void setPrintDetail(com.fedex.openship.stub.ShippingDocumentPrintDetail printDetail) {
        this.printDetail = printDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ShippingDocumentDispositionDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dispositionType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DispositionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ShippingDocumentEMailDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("printDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PrintDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ShippingDocumentPrintDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
