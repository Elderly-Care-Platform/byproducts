...
public class PendingShipmentProcessingOptionsRequested  implements java.io.Serializable {
    private com.fedex.openship.stub.PendingShipmentProcessingOptionType[] options;

    public PendingShipmentProcessingOptionsRequested() {
    }

    public PendingShipmentProcessingOptionsRequested(
           com.fedex.openship.stub.PendingShipmentProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.fedex.openship.stub.PendingShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.openship.stub.PendingShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public com.fedex.openship.stub.PendingShipmentProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.openship.stub.PendingShipmentProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PendingShipmentProcessingOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PendingShipmentProcessingOptionType"));
