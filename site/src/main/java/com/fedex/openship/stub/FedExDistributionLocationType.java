...
public class FedExDistributionLocationType implements java.io.Serializable {
    ...
    // Constructor
    protected FedExDistributionLocationType(java.lang.String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final java.lang.String _CUSTOMER_SPECIFIED = "CUSTOMER_SPECIFIED";
    public static final java.lang.String _FEDEX_EXPRESS_FREIGHT_RAMP = "FEDEX_EXPRESS_FREIGHT_RAMP";
    ...
    public static FedExDistributionLocationType fromValue(java.lang.String value)
    ...
    public static FedExDistributionLocationType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "FedExDistributionLocationType"));
    }
    /**
