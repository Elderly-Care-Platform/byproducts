...
public class VariableHandlingChargeDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.Money fixedValue;
     ...
     * is applied. */
    private com.fedex.openship.stub.RateElementBasisType rateElementBasis;

    /* Select the type of rate from which the element is to be selected. */
    private com.fedex.openship.stub.RateTypeBasisType rateTypeBasis;

    public VariableHandlingChargeDetail() {
    }

    public VariableHandlingChargeDetail(
           com.fedex.openship.stub.Money fixedValue,
           java.math.BigDecimal percentValue,
           com.fedex.openship.stub.RateElementBasisType rateElementBasis,
           com.fedex.openship.stub.RateTypeBasisType rateTypeBasis) {
     ...
     * @return fixedValue
     */
    public com.fedex.openship.stub.Money getFixedValue() {
        return fixedValue;
    }
     ...
     * @param fixedValue
     */
    public void setFixedValue(com.fedex.openship.stub.Money fixedValue) {
        this.fixedValue = fixedValue;
    }
     ...
     * is applied.
     */
    public com.fedex.openship.stub.RateElementBasisType getRateElementBasis() {
     ...
     * is applied.
     */
    public void setRateElementBasis(com.fedex.openship.stub.RateElementBasisType rateElementBasis) {
        this.rateElementBasis = rateElementBasis;
    }
     ...
     */
    public com.fedex.openship.stub.RateTypeBasisType getRateTypeBasis() {
     ...
     */
    public void setRateTypeBasis(com.fedex.openship.stub.RateTypeBasisType rateTypeBasis) {
        this.rateTypeBasis = rateTypeBasis;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "VariableHandlingChargeDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fixedValue");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "FixedValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PercentValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RateElementBasis"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RateElementBasisType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("rateTypeBasis");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RateTypeBasis"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RateTypeBasisType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
