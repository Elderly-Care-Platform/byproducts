...
public class NaftaCertificateOfOriginDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.DateRange blanketPeriod;
    ...
    private com.fedex.openship.stub.Contact signatureContact;

    private com.fedex.openship.stub.NaftaProducerSpecificationType producerSpecification;

    private com.fedex.openship.stub.NaftaProducer[] producers;
     ...
     */
    public com.fedex.openship.stub.DateRange getBlanketPeriod() {
        return blanketPeriod;
    }
     ...
     * @param blanketPeriod
     */
    public void setBlanketPeriod(com.fedex.openship.stub.DateRange blanketPeriod) {
        this.blanketPeriod = blanketPeriod;
    }
     ...
     */
    public com.fedex.openship.stub.Contact getSignatureContact() {
     ...
     */
    public void setSignatureContact(com.fedex.openship.stub.Contact signatureContact) {
        this.signatureContact = signatureContact;
    }
     ...
     * @return producers
     */
    public com.fedex.openship.stub.NaftaProducer[] getProducers() {
        return producers;
    }
     ...
     * @param producers
     */
    public void setProducers(com.fedex.openship.stub.NaftaProducer[] producers) {
        this.producers = producers;
    }

    public com.fedex.openship.stub.NaftaProducer getProducers(int i) {
        return this.producers[i];
    }

    public void setProducers(int i, com.fedex.openship.stub.NaftaProducer _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaCertificateOfOriginDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "BlanketPeriod"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ImporterSpecification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaImporterSpecificationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("signatureContact");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "SignatureContact"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ProducerSpecification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaProducerSpecificationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("producers");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Producers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaProducer"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
