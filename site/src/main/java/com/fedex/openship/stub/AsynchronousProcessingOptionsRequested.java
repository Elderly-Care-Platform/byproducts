...
public class AsynchronousProcessingOptionsRequested  implements java.io.Serializable {
    private com.fedex.openship.stub.AsynchronousProcessingOptionType[] options;

    public AsynchronousProcessingOptionsRequested() {
    }

    public AsynchronousProcessingOptionsRequested(
           com.fedex.openship.stub.AsynchronousProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.fedex.openship.stub.AsynchronousProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.openship.stub.AsynchronousProcessingOptionType[] options) {
        this.options = options;
    }

    public com.fedex.openship.stub.AsynchronousProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.openship.stub.AsynchronousProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AsynchronousProcessingOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AsynchronousProcessingOptionType"));
