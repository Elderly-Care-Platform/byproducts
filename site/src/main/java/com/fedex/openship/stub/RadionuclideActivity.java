...
public class RadionuclideActivity  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.RadioactivityUnitOfMeasure unitOfMeasure;
    ...
    public RadionuclideActivity(
           ...
           com.fedex.openship.stub.RadioactivityUnitOfMeasure unitOfMeasure) {
           this.value = value;
     ...
     */
    public com.fedex.openship.stub.RadioactivityUnitOfMeasure getUnitOfMeasure() {
        return unitOfMeasure;
    }
     ...
     * @param unitOfMeasure
     */
    public void setUnitOfMeasure(com.fedex.openship.stub.RadioactivityUnitOfMeasure unitOfMeasure) {
        this.unitOfMeasure = unitOfMeasure;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RadionuclideActivity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "UnitOfMeasure"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RadioactivityUnitOfMeasure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
