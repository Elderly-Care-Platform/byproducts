...
public class HoldAtLocationDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.FedExLocationType locationType;
    ...
    public HoldAtLocationDetail(
           ...
           com.fedex.openship.stub.FedExLocationType locationType) {
     ...
     */
    public com.fedex.openship.stub.FedExLocationType getLocationType() {
        return locationType;
    }
     ...
     */
    public void setLocationType(com.fedex.openship.stub.FedExLocationType locationType) {
        this.locationType = locationType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "HoldAtLocationDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LocationType"));
