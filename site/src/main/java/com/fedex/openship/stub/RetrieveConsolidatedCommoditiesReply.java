...
public class RetrieveConsolidatedCommoditiesReply  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.ConsolidatedCommoditiesSummaryDetail consolidatedCommoditiesSummary;
    ...
    public RetrieveConsolidatedCommoditiesReply(
           ...
           com.fedex.openship.stub.ConsolidatedCommoditiesSummaryDetail consolidatedCommoditiesSummary) {
     ...
     * the total customs value.
     */
    public com.fedex.openship.stub.ConsolidatedCommoditiesSummaryDetail getConsolidatedCommoditiesSummary() {
     ...
     * the total customs value.
     */
    public void setConsolidatedCommoditiesSummary(com.fedex.openship.stub.ConsolidatedCommoditiesSummaryDetail consolidatedCommoditiesSummary) {
        this.consolidatedCommoditiesSummary = consolidatedCommoditiesSummary;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RetrieveConsolidatedCommoditiesReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidatedCommoditiesSummary"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidatedCommoditiesSummaryDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
