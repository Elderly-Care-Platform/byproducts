...
public class DocTabContentZone001  implements java.io.Serializable {
    private com.fedex.openship.stub.DocTabZoneSpecification[] docTabZoneSpecifications;

    public DocTabContentZone001() {
    }

    public DocTabContentZone001(
           com.fedex.openship.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
     ...
     */
    public com.fedex.openship.stub.DocTabZoneSpecification[] getDocTabZoneSpecifications() {
        return docTabZoneSpecifications;
    }
     ...
     */
    public void setDocTabZoneSpecifications(com.fedex.openship.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
        this.docTabZoneSpecifications = docTabZoneSpecifications;
    }

    public com.fedex.openship.stub.DocTabZoneSpecification getDocTabZoneSpecifications(int i) {
        return this.docTabZoneSpecifications[i];
    }

    public void setDocTabZoneSpecifications(int i, com.fedex.openship.stub.DocTabZoneSpecification _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DocTabContentZone001"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("docTabZoneSpecifications");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DocTabZoneSpecifications"));
