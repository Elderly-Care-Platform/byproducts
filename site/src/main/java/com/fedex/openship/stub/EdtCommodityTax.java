...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.EdtTaxDetail[] taxes;
    ...
    public EdtCommodityTax(
           ...
           com.fedex.openship.stub.EdtTaxDetail[] taxes) {
     ...
     * @return taxes
     */
    public com.fedex.openship.stub.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.fedex.openship.stub.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.fedex.openship.stub.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.fedex.openship.stub.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
