...
public class NaftaLowValueStatementDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.CustomsRoleType role;

    public NaftaLowValueStatementDetail() {
    }

    public NaftaLowValueStatementDetail(
           com.fedex.openship.stub.CustomsRoleType role) {
           this.role = role;
    }
     ...
     */
    public com.fedex.openship.stub.CustomsRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.fedex.openship.stub.CustomsRoleType role) {
        this.role = role;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaLowValueStatementDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("role");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Role"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomsRoleType"));
