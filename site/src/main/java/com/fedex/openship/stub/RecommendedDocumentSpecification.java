...
public class RecommendedDocumentSpecification  implements java.io.Serializable {
    private com.fedex.openship.stub.RecommendedDocumentType[] types;

    public RecommendedDocumentSpecification() {
    }

    public RecommendedDocumentSpecification(
           com.fedex.openship.stub.RecommendedDocumentType[] types) {
           this.types = types;
    }
     ...
     * @return types
     */
    public com.fedex.openship.stub.RecommendedDocumentType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(com.fedex.openship.stub.RecommendedDocumentType[] types) {
        this.types = types;
    }

    public com.fedex.openship.stub.RecommendedDocumentType getTypes(int i) {
        return this.types[i];
    }

    public void setTypes(int i, com.fedex.openship.stub.RecommendedDocumentType _value) {
        this.types[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RecommendedDocumentSpecification"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RecommendedDocumentType"));
