/**
 * GetModifyOpenShipmentResultsRequest.java
 *
...
public class GetModifyOpenShipmentResultsRequest  implements java.io.Serializable {
    ...
    public GetModifyOpenShipmentResultsRequest() {
    }
    ...
    /**
     * Gets the webAuthenticationDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Sets the webAuthenticationDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Gets the clientDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @return clientDetail
     */
    ...
    /**
     * Sets the clientDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @param clientDetail
     */
    ...
    /**
     * Gets the transactionDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Sets the transactionDetail value for this GetModifyOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Gets the version value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @param version
     */
    ...
    /**
     * Gets the jobId value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @return jobId
     */
    ...
    /**
     * Sets the jobId value for this GetModifyOpenShipmentResultsRequest.
     * 
     * @param jobId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetModifyOpenShipmentResultsRequest)) return false;
        GetModifyOpenShipmentResultsRequest other = (GetModifyOpenShipmentResultsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetModifyOpenShipmentResultsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "GetModifyOpenShipmentResultsRequest"));
