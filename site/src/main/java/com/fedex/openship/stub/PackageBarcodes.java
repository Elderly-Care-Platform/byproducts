...
public class PackageBarcodes  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.BinaryBarcode[] binaryBarcodes;

    /* String-style barcodes for this package. */
    private com.fedex.openship.stub.StringBarcode[] stringBarcodes;

    public PackageBarcodes() {
    }

    public PackageBarcodes(
           com.fedex.openship.stub.BinaryBarcode[] binaryBarcodes,
           com.fedex.openship.stub.StringBarcode[] stringBarcodes) {
     ...
     */
    public com.fedex.openship.stub.BinaryBarcode[] getBinaryBarcodes() {
     ...
     */
    public void setBinaryBarcodes(com.fedex.openship.stub.BinaryBarcode[] binaryBarcodes) {
        this.binaryBarcodes = binaryBarcodes;
    }

    public com.fedex.openship.stub.BinaryBarcode getBinaryBarcodes(int i) {
        return this.binaryBarcodes[i];
    }

    public void setBinaryBarcodes(int i, com.fedex.openship.stub.BinaryBarcode _value) {
     ...
     */
    public com.fedex.openship.stub.StringBarcode[] getStringBarcodes() {
     ...
     */
    public void setStringBarcodes(com.fedex.openship.stub.StringBarcode[] stringBarcodes) {
        this.stringBarcodes = stringBarcodes;
    }

    public com.fedex.openship.stub.StringBarcode getStringBarcodes(int i) {
        return this.stringBarcodes[i];
    }

    public void setStringBarcodes(int i, com.fedex.openship.stub.StringBarcode _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageBarcodes"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("binaryBarcodes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "BinaryBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "BinaryBarcode"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "StringBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "StringBarcode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
