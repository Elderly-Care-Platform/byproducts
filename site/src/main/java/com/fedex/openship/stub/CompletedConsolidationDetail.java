...
public class CompletedConsolidationDetail  implements java.io.Serializable {
     ...
     * consolidation. */
    private com.fedex.openship.stub.ConsolidationShipment[] consolidationShipments;

    /* Contains all documents produced for this distribution consolidation. */
    private com.fedex.openship.stub.ConsolidationDocument[] documents;

    public CompletedConsolidationDetail() {
    }

    public CompletedConsolidationDetail(
           com.fedex.openship.stub.ConsolidationShipment[] consolidationShipments,
           com.fedex.openship.stub.ConsolidationDocument[] documents) {
     ...
     * consolidation.
     */
    public com.fedex.openship.stub.ConsolidationShipment[] getConsolidationShipments() {
     ...
     * consolidation.
     */
    public void setConsolidationShipments(com.fedex.openship.stub.ConsolidationShipment[] consolidationShipments) {
        this.consolidationShipments = consolidationShipments;
    }

    public com.fedex.openship.stub.ConsolidationShipment getConsolidationShipments(int i) {
        return this.consolidationShipments[i];
    }

    public void setConsolidationShipments(int i, com.fedex.openship.stub.ConsolidationShipment _value) {
     ...
     */
    public com.fedex.openship.stub.ConsolidationDocument[] getDocuments() {
        return documents;
    }
     ...
     */
    public void setDocuments(com.fedex.openship.stub.ConsolidationDocument[] documents) {
        this.documents = documents;
    }

    public com.fedex.openship.stub.ConsolidationDocument getDocuments(int i) {
        return this.documents[i];
    }

    public void setDocuments(int i, com.fedex.openship.stub.ConsolidationDocument _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getConsolidationShipments() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getConsolidationShipments(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CompletedConsolidationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("consolidationShipments");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationShipments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationShipment"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationDocument"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
