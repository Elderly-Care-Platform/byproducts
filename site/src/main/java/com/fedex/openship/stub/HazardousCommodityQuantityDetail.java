...
public class HazardousCommodityQuantityDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.HazardousCommodityQuantityType quantityType;
    ...
    public HazardousCommodityQuantityDetail(
           ...
           com.fedex.openship.stub.HazardousCommodityQuantityType quantityType) {
           this.amount = amount;
           this.units = units;
     ...
     */
    public com.fedex.openship.stub.HazardousCommodityQuantityType getQuantityType() {
        return quantityType;
    }
     ...
     */
    public void setQuantityType(com.fedex.openship.stub.HazardousCommodityQuantityType quantityType) {
        this.quantityType = quantityType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "HazardousCommodityQuantityDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Units"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "QuantityType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "HazardousCommodityQuantityType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
