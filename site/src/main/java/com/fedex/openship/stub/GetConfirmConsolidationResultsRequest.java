/**
 * GetConfirmConsolidationResultsRequest.java
 *
...
public class GetConfirmConsolidationResultsRequest  implements java.io.Serializable {
    ...
    public GetConfirmConsolidationResultsRequest() {
    }
    ...
    /**
     * Gets the webAuthenticationDetail value for this GetConfirmConsolidationResultsRequest.
     * 
    ...
    /**
     * Sets the webAuthenticationDetail value for this GetConfirmConsolidationResultsRequest.
     * 
    ...
    /**
     * Gets the clientDetail value for this GetConfirmConsolidationResultsRequest.
     * 
     * @return clientDetail
     */
    ...
    /**
     * Sets the clientDetail value for this GetConfirmConsolidationResultsRequest.
     * 
     * @param clientDetail
     */
    ...
    /**
     * Gets the transactionDetail value for this GetConfirmConsolidationResultsRequest.
     * 
    ...
    /**
     * Sets the transactionDetail value for this GetConfirmConsolidationResultsRequest.
     * 
    ...
    /**
     * Gets the version value for this GetConfirmConsolidationResultsRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetConfirmConsolidationResultsRequest.
     * 
     * @param version
     */
    ...
    /**
     * Gets the jobId value for this GetConfirmConsolidationResultsRequest.
     * 
     * @return jobId
     */
    ...
    /**
     * Sets the jobId value for this GetConfirmConsolidationResultsRequest.
     * 
     * @param jobId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetConfirmConsolidationResultsRequest)) return false;
        GetConfirmConsolidationResultsRequest other = (GetConfirmConsolidationResultsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetConfirmConsolidationResultsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "GetConfirmConsolidationResultsRequest"));
