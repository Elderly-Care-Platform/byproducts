/**
 * GetCreateOpenShipmentResultsRequest.java
 *
...
public class GetCreateOpenShipmentResultsRequest  implements java.io.Serializable {
    ...
    public GetCreateOpenShipmentResultsRequest() {
    }
    ...
    /**
     * Gets the webAuthenticationDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Sets the webAuthenticationDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Gets the clientDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @return clientDetail
     */
    ...
    /**
     * Sets the clientDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @param clientDetail
     */
    ...
    /**
     * Gets the transactionDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Sets the transactionDetail value for this GetCreateOpenShipmentResultsRequest.
     * 
    ...
    /**
     * Gets the version value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @param version
     */
    ...
    /**
     * Gets the jobId value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @return jobId
     */
    ...
    /**
     * Sets the jobId value for this GetCreateOpenShipmentResultsRequest.
     * 
     * @param jobId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCreateOpenShipmentResultsRequest)) return false;
        GetCreateOpenShipmentResultsRequest other = (GetCreateOpenShipmentResultsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCreateOpenShipmentResultsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "GetCreateOpenShipmentResultsRequest"));
