...
public class AdrLicenseDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.LicenseOrPermitDetail licenseOrPermitDetail;

    public AdrLicenseDetail() {
    }

    public AdrLicenseDetail(
           com.fedex.openship.stub.LicenseOrPermitDetail licenseOrPermitDetail) {
     ...
     */
    public com.fedex.openship.stub.LicenseOrPermitDetail getLicenseOrPermitDetail() {
        return licenseOrPermitDetail;
    }
     ...
     */
    public void setLicenseOrPermitDetail(com.fedex.openship.stub.LicenseOrPermitDetail licenseOrPermitDetail) {
        this.licenseOrPermitDetail = licenseOrPermitDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AdrLicenseDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("licenseOrPermitDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LicenseOrPermitDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "LicenseOrPermitDetail"));
