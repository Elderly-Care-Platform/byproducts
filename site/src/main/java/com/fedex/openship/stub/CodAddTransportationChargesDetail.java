...
public class CodAddTransportationChargesDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.ChargeBasisLevelType chargeBasisLevel;
    ...
    public CodAddTransportationChargesDetail(
           ...
           com.fedex.openship.stub.ChargeBasisLevelType chargeBasisLevel) {
     ...
     */
    public com.fedex.openship.stub.ChargeBasisLevelType getChargeBasisLevel() {
        return chargeBasisLevel;
    }
     ...
     */
    public void setChargeBasisLevel(com.fedex.openship.stub.ChargeBasisLevelType chargeBasisLevel) {
        this.chargeBasisLevel = chargeBasisLevel;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodAddTransportationChargesDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodAddTransportationChargeBasisType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chargeBasisLevel");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ChargeBasisLevel"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ChargeBasisLevelType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
