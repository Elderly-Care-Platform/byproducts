...
public class FreightGuaranteeDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.FreightGuaranteeType type;
    ...
    public FreightGuaranteeDetail(
           com.fedex.openship.stub.FreightGuaranteeType type,
           java.util.Date date) {
           this.type = type;
           this.date = date;
    }
     ...
     * @return type
     */
    public com.fedex.openship.stub.FreightGuaranteeType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.openship.stub.FreightGuaranteeType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "FreightGuaranteeDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "FreightGuaranteeType"));
