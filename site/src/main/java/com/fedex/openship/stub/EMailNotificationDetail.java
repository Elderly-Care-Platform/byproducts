...
public class EMailNotificationDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.EMailNotificationAggregationType aggregationType;
    ...
    private com.fedex.openship.stub.EMailNotificationRecipient[] recipients;

    public EMailNotificationDetail() {
    }

    public EMailNotificationDetail(
           com.fedex.openship.stub.EMailNotificationAggregationType aggregationType,
           java.lang.String personalMessage,
           com.fedex.openship.stub.EMailNotificationRecipient[] recipients) {
     ...
     */
    public com.fedex.openship.stub.EMailNotificationAggregationType getAggregationType() {
     ...
     */
    public void setAggregationType(com.fedex.openship.stub.EMailNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     * of the email and events to be notified on
     */
    public com.fedex.openship.stub.EMailNotificationRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * of the email and events to be notified on
     */
    public void setRecipients(com.fedex.openship.stub.EMailNotificationRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.openship.stub.EMailNotificationRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.openship.stub.EMailNotificationRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailNotificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aggregationType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AggregationType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailNotificationAggregationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("personalMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PersonalMessage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Recipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailNotificationRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
