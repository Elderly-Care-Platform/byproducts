...
public class ConsolidationSpecialServicesRequested  implements java.io.Serializable {
     ...
     * consolidation. */
    private com.fedex.openship.stub.ConsolidationSpecialServiceType[] specialServiceTypes;
    ...
    public ConsolidationSpecialServicesRequested(
           com.fedex.openship.stub.ConsolidationSpecialServiceType[] specialServiceTypes,
     ...
     * consolidation.
     */
    public com.fedex.openship.stub.ConsolidationSpecialServiceType[] getSpecialServiceTypes() {
     ...
     * consolidation.
     */
    public void setSpecialServiceTypes(com.fedex.openship.stub.ConsolidationSpecialServiceType[] specialServiceTypes) {
        this.specialServiceTypes = specialServiceTypes;
    }

    public com.fedex.openship.stub.ConsolidationSpecialServiceType getSpecialServiceTypes(int i) {
        return this.specialServiceTypes[i];
    }

    public void setSpecialServiceTypes(int i, com.fedex.openship.stub.ConsolidationSpecialServiceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationSpecialServicesRequested"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationSpecialServiceType"));
