...
public class EtdDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.RequestedShippingDocumentType[] requestedDocumentCopies;

    private com.fedex.openship.stub.UploadDocumentDetail[] documents;
    ...
    public EtdDetail(
           com.fedex.openship.stub.RequestedShippingDocumentType[] requestedDocumentCopies,
           com.fedex.openship.stub.UploadDocumentDetail[] documents,
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public com.fedex.openship.stub.RequestedShippingDocumentType[] getRequestedDocumentCopies() {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public void setRequestedDocumentCopies(com.fedex.openship.stub.RequestedShippingDocumentType[] requestedDocumentCopies) {
        this.requestedDocumentCopies = requestedDocumentCopies;
    }

    public com.fedex.openship.stub.RequestedShippingDocumentType getRequestedDocumentCopies(int i) {
        return this.requestedDocumentCopies[i];
    }

    public void setRequestedDocumentCopies(int i, com.fedex.openship.stub.RequestedShippingDocumentType _value) {
     ...
     * @return documents
     */
    public com.fedex.openship.stub.UploadDocumentDetail[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(com.fedex.openship.stub.UploadDocumentDetail[] documents) {
        this.documents = documents;
    }

    public com.fedex.openship.stub.UploadDocumentDetail getDocuments(int i) {
        return this.documents[i];
    }

    public void setDocuments(int i, com.fedex.openship.stub.UploadDocumentDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EtdDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("requestedDocumentCopies");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RequestedDocumentCopies"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Documents"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "UploadDocumentDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
