...
public class DeclarationValueType implements java.io.Serializable {
    ...
    // Constructor
    protected DeclarationValueType(java.lang.String value) {
        _value_ = value;
    ...
    public static DeclarationValueType fromValue(java.lang.String value)
    ...
    public static DeclarationValueType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DeclarationValueType"));
    }
    /**
