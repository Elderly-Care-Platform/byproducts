...
public class CustomLabelBoxEntry  implements java.io.Serializable {
    private com.fedex.openship.stub.CustomLabelPosition topLeftCorner;

    private com.fedex.openship.stub.CustomLabelPosition bottomRightCorner;

    public CustomLabelBoxEntry() {
    }

    public CustomLabelBoxEntry(
           com.fedex.openship.stub.CustomLabelPosition topLeftCorner,
           com.fedex.openship.stub.CustomLabelPosition bottomRightCorner) {
     ...
     */
    public com.fedex.openship.stub.CustomLabelPosition getTopLeftCorner() {
        return topLeftCorner;
    }
     ...
     * @param topLeftCorner
     */
    public void setTopLeftCorner(com.fedex.openship.stub.CustomLabelPosition topLeftCorner) {
        this.topLeftCorner = topLeftCorner;
    }
     ...
     */
    public com.fedex.openship.stub.CustomLabelPosition getBottomRightCorner() {
        return bottomRightCorner;
    }
     ...
     */
    public void setBottomRightCorner(com.fedex.openship.stub.CustomLabelPosition bottomRightCorner) {
        this.bottomRightCorner = bottomRightCorner;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomLabelBoxEntry"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("topLeftCorner");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "TopLeftCorner"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "BottomRightCorner"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomLabelPosition"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
