/**
 * RetrieveConsolidationReply.java
 *
...
public class RetrieveConsolidationReply  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.RequestedConsolidation requestedConsolidation;

    public RetrieveConsolidationReply() {
    }
    ...
    public RetrieveConsolidationReply(
           ...
           com.fedex.openship.stub.RequestedConsolidation requestedConsolidation) {
    ...
    /**
     * Gets the highestSeverity value for this RetrieveConsolidationReply.
     * 
    ...
    /**
     * Sets the highestSeverity value for this RetrieveConsolidationReply.
     * 
    ...
    /**
     * Gets the notifications value for this RetrieveConsolidationReply.
     * 
    ...
    /**
     * Sets the notifications value for this RetrieveConsolidationReply.
     * 
     * @param notifications
     */
    ...
    /**
     * Gets the transactionDetail value for this RetrieveConsolidationReply.
     * 
    ...
    /**
     * Sets the transactionDetail value for this RetrieveConsolidationReply.
     * 
    ...
    /**
     * Gets the version value for this RetrieveConsolidationReply.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this RetrieveConsolidationReply.
     * 
     * @param version
     */
    ...
    /**
     * Gets the requestedConsolidation value for this RetrieveConsolidationReply.
     * 
     * @return requestedConsolidation
     */
    public com.fedex.openship.stub.RequestedConsolidation getRequestedConsolidation() {
        return requestedConsolidation;
    }


    /**
     * Sets the requestedConsolidation value for this RetrieveConsolidationReply.
     * 
     * @param requestedConsolidation
     */
    public void setRequestedConsolidation(com.fedex.openship.stub.RequestedConsolidation requestedConsolidation) {
        this.requestedConsolidation = requestedConsolidation;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveConsolidationReply)) return false;
        RetrieveConsolidationReply other = (RetrieveConsolidationReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveConsolidationReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RetrieveConsolidationReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RequestedConsolidation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "RequestedConsolidation"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
