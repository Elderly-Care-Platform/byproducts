...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.EMailRecipient[] recipients;
    ...
    public EMailLabelDetail(
           ...
           com.fedex.openship.stub.EMailRecipient[] recipients) {
     ...
     * @return recipients
     */
    public com.fedex.openship.stub.EMailRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * @param recipients
     */
    public void setRecipients(com.fedex.openship.stub.EMailRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.openship.stub.EMailRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.openship.stub.EMailRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailLabelDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
