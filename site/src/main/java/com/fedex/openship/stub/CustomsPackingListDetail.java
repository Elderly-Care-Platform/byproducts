...
/**
 * The instructions indicating how to print the customs packing list
 * document.
 */
public class CustomsPackingListDetail  implements java.io.Serializable {
    ...
    /**
     * Gets the format value for this CustomsPackingListDetail.
     * 
     * @return format
     */
    ...
    /**
     * Sets the format value for this CustomsPackingListDetail.
     * 
     * @param format
     */
    ...
    /**
     * Gets the customerImageUsages value for this CustomsPackingListDetail.
     * 
    ...
    /**
     * Sets the customerImageUsages value for this CustomsPackingListDetail.
     * 
    ...
    /**
     * Gets the signatureName value for this CustomsPackingListDetail.
     * 
    ...
    /**
     * Sets the signatureName value for this CustomsPackingListDetail.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomsPackingListDetail)) return false;
        CustomsPackingListDetail other = (CustomsPackingListDetail) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomsPackingListDetail.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomsPackingListDetail"));
