...
public class ConsolidationSpecialServiceType implements java.io.Serializable {
    ...
    // Constructor
    protected ConsolidationSpecialServiceType(java.lang.String value) {
        _value_ = value;
    ...
    public static ConsolidationSpecialServiceType fromValue(java.lang.String value)
    ...
    public static ConsolidationSpecialServiceType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ConsolidationSpecialServiceType"));
    }
    /**
