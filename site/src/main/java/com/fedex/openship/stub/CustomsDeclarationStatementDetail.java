...
public class CustomsDeclarationStatementDetail  implements java.io.Serializable {
    ...
    private com.fedex.openship.stub.CustomsDeclarationStatementType[] types;

    /* Specifies the NAFTA low value statement information. */
    private com.fedex.openship.stub.NaftaLowValueStatementDetail naftaLowValueStatementDetail;

    public CustomsDeclarationStatementDetail() {
    }

    public CustomsDeclarationStatementDetail(
           com.fedex.openship.stub.CustomsDeclarationStatementType[] types,
           com.fedex.openship.stub.NaftaLowValueStatementDetail naftaLowValueStatementDetail) {
           this.types = types;
     ...
     * and/or certifications that apply to this shipment.
     */
    public com.fedex.openship.stub.CustomsDeclarationStatementType[] getTypes() {
        return types;
    }
     ...
     * and/or certifications that apply to this shipment.
     */
    public void setTypes(com.fedex.openship.stub.CustomsDeclarationStatementType[] types) {
        this.types = types;
    }

    public com.fedex.openship.stub.CustomsDeclarationStatementType getTypes(int i) {
        return this.types[i];
    }

    public void setTypes(int i, com.fedex.openship.stub.CustomsDeclarationStatementType _value) {
        this.types[i] = _value;
    }
     ...
     */
    public com.fedex.openship.stub.NaftaLowValueStatementDetail getNaftaLowValueStatementDetail() {
     ...
     */
    public void setNaftaLowValueStatementDetail(com.fedex.openship.stub.NaftaLowValueStatementDetail naftaLowValueStatementDetail) {
        this.naftaLowValueStatementDetail = naftaLowValueStatementDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomsDeclarationStatementDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("types");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Types"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CustomsDeclarationStatementType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaLowValueStatementDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "NaftaLowValueStatementDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
