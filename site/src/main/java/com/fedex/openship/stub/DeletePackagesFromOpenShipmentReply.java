/**
 * DeletePackagesFromOpenShipmentReply.java
 *
...
public class DeletePackagesFromOpenShipmentReply  implements java.io.Serializable {
    ...
    public DeletePackagesFromOpenShipmentReply() {
    }
    ...
    /**
     * Gets the highestSeverity value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Sets the highestSeverity value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Gets the notifications value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Sets the notifications value for this DeletePackagesFromOpenShipmentReply.
     * 
     * @param notifications
     */
    ...
    /**
     * Gets the transactionDetail value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Sets the transactionDetail value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Gets the version value for this DeletePackagesFromOpenShipmentReply.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this DeletePackagesFromOpenShipmentReply.
     * 
     * @param version
     */
    ...
    /**
     * Gets the completedShipmentDetail value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    /**
     * Sets the completedShipmentDetail value for this DeletePackagesFromOpenShipmentReply.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeletePackagesFromOpenShipmentReply)) return false;
        DeletePackagesFromOpenShipmentReply other = (DeletePackagesFromOpenShipmentReply) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeletePackagesFromOpenShipmentReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "DeletePackagesFromOpenShipmentReply"));
