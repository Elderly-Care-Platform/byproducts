...
public class CodReturnPackageDetail  implements java.io.Serializable {
    private com.fedex.openship.stub.Money collectionAmount;

    private com.fedex.openship.stub.CodAdjustmentType adjustmentType;

    private java.lang.Boolean electronic;

    private com.fedex.openship.stub.PackageBarcodes barcodes;
    ...
    public CodReturnPackageDetail(
           com.fedex.openship.stub.Money collectionAmount,
           com.fedex.openship.stub.CodAdjustmentType adjustmentType,
           java.lang.Boolean electronic,
           com.fedex.openship.stub.PackageBarcodes barcodes,
     ...
     */
    public com.fedex.openship.stub.Money getCollectionAmount() {
        return collectionAmount;
    }
     ...
     */
    public void setCollectionAmount(com.fedex.openship.stub.Money collectionAmount) {
        this.collectionAmount = collectionAmount;
    }
     ...
     */
    public com.fedex.openship.stub.CodAdjustmentType getAdjustmentType() {
        return adjustmentType;
    }
     ...
     */
    public void setAdjustmentType(com.fedex.openship.stub.CodAdjustmentType adjustmentType) {
        this.adjustmentType = adjustmentType;
    }
     ...
     * @return barcodes
     */
    public com.fedex.openship.stub.PackageBarcodes getBarcodes() {
        return barcodes;
    }
     ...
     * @param barcodes
     */
    public void setBarcodes(com.fedex.openship.stub.PackageBarcodes barcodes) {
        this.barcodes = barcodes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodReturnPackageDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("collectionAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CollectionAmount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "AdjustmentType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "CodAdjustmentType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("electronic");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Electronic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "Barcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "PackageBarcodes"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
