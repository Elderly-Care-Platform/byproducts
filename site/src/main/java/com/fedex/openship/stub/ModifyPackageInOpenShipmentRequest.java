/**
 * ModifyPackageInOpenShipmentRequest.java
 *
...
public class ModifyPackageInOpenShipmentRequest  implements java.io.Serializable {
    ...
    /* Specifies the optional actions that can be performed during
     * the modification of packages in Open Shipment */
    private com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType[] actions;

    /* Specifies the tracking id of the package that is to be modified
     * in the open shipment. */
    private com.fedex.openship.stub.TrackingId trackingId;

    /* Contains the data for the package that is to be modified in
     * the open shipment. */
    private com.fedex.openship.stub.RequestedPackageLineItem requestedPackageLineItem;

    public ModifyPackageInOpenShipmentRequest() {
    }
    ...
    public ModifyPackageInOpenShipmentRequest(
           ...
           com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType[] actions,
    ...
    /**
     * Gets the webAuthenticationDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Sets the webAuthenticationDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Gets the clientDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @return clientDetail
     */
    ...
    /**
     * Sets the clientDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @param clientDetail
     */
    ...
    /**
     * Gets the transactionDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Sets the transactionDetail value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Gets the version value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @param version
     */
    ...
    /**
     * Gets the index value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Sets the index value for this ModifyPackageInOpenShipmentRequest.
     * 
    ...
    /**
     * Gets the actions value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @return actions   * Specifies the optional actions that can be performed during
     * the modification of packages in Open Shipment
     */
    public com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType[] getActions() {
        return actions;
    }


    /**
     * Sets the actions value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @param actions   * Specifies the optional actions that can be performed during
     * the modification of packages in Open Shipment
     */
    public void setActions(com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType[] actions) {
        this.actions = actions;
    }

    public com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType getActions(int i) {
        return this.actions[i];
    }

    public void setActions(int i, com.fedex.openship.stub.ModifyPackageInOpenShipmentActionType _value) {
        this.actions[i] = _value;
    }


    /**
     * Gets the trackingId value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @return trackingId   * Specifies the tracking id of the package that is to be modified
     * in the open shipment.
     */
    ...
    /**
     * Sets the trackingId value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @param trackingId   * Specifies the tracking id of the package that is to be modified
     * in the open shipment.
     */
    ...
    /**
     * Gets the requestedPackageLineItem value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @return requestedPackageLineItem   * Contains the data for the package that is to be modified in
     * the open shipment.
     */
    ...
    /**
     * Sets the requestedPackageLineItem value for this ModifyPackageInOpenShipmentRequest.
     * 
     * @param requestedPackageLineItem   * Contains the data for the package that is to be modified in
     * the open shipment.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModifyPackageInOpenShipmentRequest)) return false;
        ModifyPackageInOpenShipmentRequest other = (ModifyPackageInOpenShipmentRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModifyPackageInOpenShipmentRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ModifyPackageInOpenShipmentRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v7", "ModifyPackageInOpenShipmentActionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
