...
public class CatalogEndpoint extends
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findProductsByQuery(javax .servlet.http.HttpServletRequest,
	 * java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@GET
	@Path("search/products")
	public SearchResultsWrapper findProductsByQuery(
			@Context HttpServletRequest request, @QueryParam("q") String q,
		...
		try {
			if (StringUtils.isNotEmpty(q)) {
				...
				throw BroadleafWebServicesException
						.build(Response.Status.BAD_REQUEST.getStatusCode())
						.addMessage(
								BroadleafWebServicesException.SEARCH_QUERY_EMPTY);
			}
		} catch (ServiceException e) {
			throw BroadleafWebServicesException.build(
					Response.Status.BAD_REQUEST.getStatusCode()).addMessage(
					BroadleafWebServicesException.SEARCH_QUERY_MALFORMED, q);
		}
		...
		try {
			...
			if (null != products) {
				...
				List<Category> categoryList = catalogService
						.findAllCategories();
				...
				for (Category category : categoryActiveList) {
					List<Product> productList = catalogService
							.findActiveProductsByCategory(category);
				...
				List<Product> activeProductList = new ArrayList<Product>(
						activeProductSet);
				// Pagination
				activeProductList = getProductPagination(activeProductList,
						page, pageSize);
	...
	/**
	 * Get List of all active products, excluding products which are in deleted
	 * category
	 * 
	 * @param request
	 * @param productLimit
	...
	public SearchResultsWrapper getAllActiveProducts(
		...
		for (Category category : categoryActiveList) {
			List<Product> Catproducts = catalogService
					.findActiveProductsByCategory(category);
			if (Catproducts != null) {
		...
		for (Product product : productsList) {
			ProductWrapper wrapper = (ProductWrapper) context
					.getBean(ProductWrapper.class.getName());
	...
	/**
	 * Get Count of all active products, excluding products which are in deleted
	 * category
	 * 
	 * @param request
	 * @param productLimit
	...
	public List<ProductWrapper> findFeaturedProductsByQuery(
			@Context HttpServletRequest request,
			@QueryParam("pageSize") @DefaultValue("15") Integer pageSize,
			@QueryParam("page") @DefaultValue("1") Integer page) {
	...
	/*
	 * This method is used to get product based on search query from particular
	 * category
	 * 
	 * (non-Javadoc)
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findProductsByCategoryAndQuery (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long, java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@GET
	@Path("search/category/{categoryId}/products")
	public SearchResultsWrapper findProductsByCategoryAndQuery(
			@Context HttpServletRequest request,
		...
		if (categoryId == null) {
			throw BroadleafWebServicesException.build(
					Response.Status.BAD_REQUEST.getStatusCode()).addMessage(
					BroadleafWebServicesException.INVALID_CATEGORY_ID,
					categoryId);
		}
		...
		try {
			...
			if (!("*").equals(q) || activeProducts.size() <= 0) {
				...
				result = getSearchService().findProductsByCategoryAndQuery(
						category, q, searchCriteria);
				List<Product> products = result.getProducts();
				if (null != products) {
					for (Product product : products) {
						if (product.getDefaultCategory().isActive()
								&& product.isActive()) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findSkusByProductById(javax .servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("product/{id}/skus")
	public List<SkuWrapper> findSkusByProductById(
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findDefaultSkuByProductId (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("product/{id}/defaultSku")
	public SkuWrapper findDefaultSkuByProductId(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findAllCategories(javax .servlet.http.HttpServletRequest,
	 * java.lang.String, int, int)
	 */
	@Override
	@GET
	@Path("categories")
	public CategoriesWrapper findAllCategories(
			@Context HttpServletRequest request,
		...
		CategoriesWrapper wrapper = (CategoriesWrapper) context
				.getBean(CategoriesWrapper.class.getName());
	...
	public CategoriesWrapper findRootCategories(
			@Context HttpServletRequest request) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findSubCategories(javax .servlet.http.HttpServletRequest, java.lang.Long,
	 * int, int, boolean)
	 */
	@Override
	@GET
	@Path("category/{id}/categories")
	public CategoriesWrapper findSubCategories(
			@Context HttpServletRequest request, @PathParam("id") Long id,
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findActiveSubCategories (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long, int, int)
	 */
	@Override
	@GET
	@Path("category/{id}/activeSubcategories")
	public CategoriesWrapper findActiveSubCategories(
			@Context HttpServletRequest request, @PathParam("id") Long id,
			@QueryParam("limit") @DefaultValue("20") int limit,
			@QueryParam("offset") @DefaultValue("0") int offset) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findCategoryById(javax. servlet.http.HttpServletRequest, java.lang.Long,
	 * int, int, int, int)
	 */
	@Override
	@GET
	@Path("category/{id}")
	public CategoryWrapper findCategoryById(
			@Context HttpServletRequest request,
			@PathParam("id") Long id,
			@QueryParam("productLimit") @DefaultValue("20") int productLimit,
			@QueryParam("productOffset") @DefaultValue("1") int productOffset,
		...
		if (cat != null) {
			...
			CategoryWrapper wrapper = (CategoryWrapper) context
					.getBean(CategoryWrapper.class.getName());
			wrapper.wrapDetails(cat, request);
			return wrapper;
		}
		throw BroadleafWebServicesException.build(
				Response.Status.NOT_FOUND.getStatusCode()).addMessage(
				BroadleafWebServicesException.CATEGORY_NOT_FOUND, id);
	}
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findCategoryByIdOrName( javax.servlet.http.HttpServletRequest,
	 * java.lang.String, int, int, int, int)
	 */
	@Override
	@GET
	@Path("category")
	public CategoryWrapper findCategoryByIdOrName(
			@Context HttpServletRequest request,
		...
		return super.findCategoryByIdOrName(request, searchParameter,
				productLimit, productOffset, subcategoryLimit,
				subcategoryOffset);
	}
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findCategoryAttributesForCategory(javax.servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findUpSaleProductsByProduct (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long, int, int)
	 */
	@Override
	@GET
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findCrossSaleProductsByProduct (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long, int, int)
	 */
	@Override
	@GET
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findProductAttributesForProduct (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findSkuAttributesForSku (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("sku/{id}/sku-attributes")
	public List<SkuAttributeWrapper> findSkuAttributesForSku(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	...
	@GET
	@Path("sku/{id}/media")
	public List<MediaWrapper> findMediaForSku(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findInventoryForSkus(javax .servlet.http.HttpServletRequest,
	 * java.util.List)
	 */
	@Override
	@GET
	@Path("sku/inventory")
	public List<InventoryWrapper> findInventoryForSkus(
			@Context HttpServletRequest request,
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findMediaForProduct(javax .servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("product/{id}/media")
	public List<MediaWrapper> findMediaForProduct(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findMediaForCategory(javax .servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("category/{id}/media")
	public List<MediaWrapper> findMediaForCategory(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	 ...
	 * 
	 * @see org.broadleafcommerce.core.web.api.endpoint.catalog.CatalogEndpoint#
	 * findParentCategoriesForProduct (javax.servlet.http.HttpServletRequest,
	 * java.lang.Long)
	 */
	@Override
	@GET
	@Path("product/{id}/categories")
	public CategoriesWrapper findParentCategoriesForProduct(
			@Context HttpServletRequest request, @PathParam("id") Long id) {
	 ...
	 * @return
	 */
	private List<Product> getProductPagination(List<Product> products,
