...
public class SkuImpl implements Sku {
    ...
    @AdminPresentation(friendlyName = "SkuImpl_Sku_TaxCode", order = 1001, excluded = false, group = ProductImpl.Presentation.Group.Name.Financial)
    ...
    @AdminPresentation(friendlyName = "SkuImpl_Sku_Start_Date", order = 1000, prominent = true,
    ...
    @AdminPresentation(friendlyName = "ProductImpl_Is_Product_Machine_Sortable", order = 10000, excluded = true,
    ...
    @AdminPresentation(friendlyName = "SkuImpl_Sku_FulfillmentType", order = 2000, excluded = true,
        tab = ProductImpl.Presentation.Tab.Name.Inventory, tabOrder = ProductImpl.Presentation.Tab.Order.Inventory,
        group = ProductImpl.Presentation.Group.Name.Inventory, groupOrder = ProductImpl.Presentation.Group.Order.Inventory,
        fieldType = SupportedFieldType.BROADLEAF_ENUMERATION, 
     ...
     */
     ...
     @AdminPresentation(friendlyName = "SkuImpl_Currency", order = 3000, excluded = true, visibility=VisibilityEnum.HIDDEN_ALL,
            tab = ProductImpl.Presentation.Tab.Name.Advanced, tabOrder = ProductImpl.Presentation.Tab.Order.Advanced,
        group = ProductImpl.Presentation.Group.Name.Advanced, groupOrder = ProductImpl.Presentation.Group.Order.Advanced)
